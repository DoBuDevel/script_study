...
// Changing the function in prototype
Person.prototype.introduce = function () {
    console.log("Hello, " + this.name + "!");
};
unikys.introduce(); // === "Hello, unikys!"
// Changing the variable in prototype
...
console.log(unikys.gender); // === "male" (female이 아니다?!);
console.log(Person.prototype.gender); // === "male" (이것도 female이 아니다?!)
